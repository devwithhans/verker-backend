...
module.exports = function auth(req, res, next) {
  ...
  // Now we can validate the token by using the jwt function verify.
  // This returns an decodedToken if the server reconises it
  ...
  // If the token is valid, are storing the userId in the request,
  // and parsing on to the next middleware
  req.userId = decodedToken.userId;
